...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            pushToast(err.message || 'Failed to generate report. Please try again.', 'error')
        } finally {
            setGenerating(false)
        }
    }
        ...
        return (
            <main className='loading-screen'>
                <div className='loading-screen__card'>
                    ...
                    <h1>{generating ? 'Building your interview strategy…' : 'Loading…'}</h1>
                    {generating && <p className='loading-screen__sub'>This may take up to 30 seconds</p>}
                </div>
            </main>
        )
    }
                ...
                <div className='interview-card__body'>
                    <div className='panel panel--left'>
                        ...
                        <div className='question-controls'>
                            <p className='question-controls__title'>Question Settings</p>
                            <div className='question-controls__grid'>
                                <label className='qc-field'>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setTechnicalCount(Math.min(20, Math.max(1, parseInt(e.target.value) || 1)))}
                                    />
                                </label>
                                <label className='qc-field'>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setBehavioralCount(Math.min(15, Math.max(1, parseInt(e.target.value) || 1)))}
                                    />
                                </label>
                                <label className='qc-field'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            >
                                ...
                                <input ref={resumeInputRef} hidden type='file' id='resume' name='resume' accept='.pdf' onChange={onInputChange} />
                            </label>
                        </div>
